...
This sample demonstrates the LPTIM interrupt wake-up from stop mode. It enters 
stop mode after each wake-up and wakes up every 500ms.
================================================================================
测试环境：
测试用板：PY32F002A_STK
MDK版本： 5.28
...
4.Wake up from stop mode after 500ms and repeatedly enter stop mode 
and wake up.
