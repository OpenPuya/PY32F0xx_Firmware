...
This sample demonstrates the GPIO external interrupt wake-up feature in sleep 
mode.
================================================================================
测试环境：
测试用板：PY32F002A_STK
...
3.Generate a falling edge on PA06 to wake up the program from sleep mode. The 
