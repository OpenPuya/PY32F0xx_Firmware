...
This sample demonstrates the VCC sampling function of the ADC module, which 
samples the value of VREFINT, calculates the value of VCC, and prints it out 
via the serial port to print it out.
================================================================================
测试环境：
测试用板：PY32F002A_STK
MDK版本： 5.28
...
2. serial port prints the voltage value of VCC every 500ms.
================================================================================
注意事项：
如果需要使用按键:
