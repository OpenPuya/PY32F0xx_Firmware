...
================================================================================
功能描述：
此样例演示了USART的中断方式发送和接收不定长数据，USART配置为9600，数据位8，
...
variable length data. USART is configured as 9600, with data bit 8, stop bit
...
PA03(RX) --> TX
GND      --> GND
3.PC端打开串口调试助手，正确连接上通讯COM口，波特率设置为9600，1位停止位，8位数
据位，无奇偶校验；
