...
2.Observe that the display on the 4-digit display is continuously updated 
in a loop.
================================================================================
注意事项：
1. 此样例需要STK板外接数码管
...
3.The SEG A B C D E F G DP pins of the 4-digit display are respectively connected 
to PB8/PA00/PA01/PA02/PA03/PA04/PA05/PA06 of the STK board.
4.Please confirm the selected chip model and whether the above IO ports are all 
available for use.
================================================================================