...
This sample demonstrates I2C communication using interrupts. The master 
sends 15 bytes of data to the slave, and then receives 15 bytes of data 
from the slave. After successful data transmission and reception between 
the master and slave, the LEDs on both the master and slave boards will 
