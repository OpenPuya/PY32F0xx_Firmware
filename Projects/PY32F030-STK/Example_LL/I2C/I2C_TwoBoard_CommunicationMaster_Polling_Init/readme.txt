...
This sample demonstrates I2C communication using polling. The master sends 15 
bytes ofdata to the slave, and then receives 15 bytes of data from the slave. 
