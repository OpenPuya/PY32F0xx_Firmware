...
using USART interrupts. After resetting the MCU and running the program again, 
the PC will receive the string "UART Test". When the PC sends 12 characters, 
the MCU will send back the same 12 characters to the PC.
================================================================================
测试环境：
测试用板：PY32F030_STK
MDK版本： 5.28
