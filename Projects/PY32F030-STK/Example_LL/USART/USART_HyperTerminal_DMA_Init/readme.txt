...
================================================================================
功能描述：
此样例演示了通过DMA收发数据的功能，复位MCU并重新运行，PC端收到字符串“UART Test”；
PC端发送12个字符，MCU会反馈同样的12个字符给PC端。

Function descriptions:
This sample demonstrates the functionality of data transmission and reception 
using DMA. After resetting the MCU and running the program again, the PC will 
receive the string "UART Test". When the PC sends 12 characters, the MCU will 
send back the same 12 characters to the PC.
================================================================================
测试环境：
测试用板：PY32F030_STK
MDK版本： 5.28
...
COM port. 
Set the baud rate to 9600, stop bits to 1, data bits to 8, and parity to none.
4.Reset the MCU and run the program again. The PC will receive the string 
"UART Test".
5.Send 12 characters from the PC. The MCU will send back the same 12 characters 
to the PC.
================================================================================
注意事项：
