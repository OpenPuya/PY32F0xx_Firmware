...
This sample demonstrates the DMA-based transmission and reception of data 
...
the MCU will receive data from 0x1 to 0xC via USART, and then send the 
received data back to the host computer.
================================================================================
测试环境：
测试用板：PY32F030_STK
MDK版本： 5.28
