...
This sample demonstrates the control of LED to display on a 4-digit display. 
The sample simultaneously controls 4 digits of the display, and the displayed 
content can be updated in real time within an interrupt.
================================================================================
测试环境：
测试用板：PY32F030_STK
MDK版本： 5.28
...
2.You will observe that the display of the 4-digit display is continuously 
updated in a loop.
================================================================================
注意事项：
1. 此样例需要stk板外接数码管
...
Notes:
1.This example requires an external 4-digit display connected to the stk 
board.
