...
2.Use an oscilloscope to monitor the frequency on the PA08 pin. After MCU starts,
it initially outputs the HSI clock with a frequency of 8MHz. Press the user 
button to switch to the HSE clock.
================================================================================
注意事项：
如果需要使用按键:
